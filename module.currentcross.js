...
//   crl recent mod             Y.one(topnode+' input.answer').set('value', this.find_java_applet(name).getMol("mrv"));
                Y.one(topnode+' input.answer').set('value', document.getElementById(appletid).getMol("mrv"));
...
// crl recent	var strvalue = "" + this.find_java_applet(name).getMol("mrv");
		var strvalue = "" + document.getElementById(appletid).getMol("mrv");
...
///insert it with embed tag

        var newApplet = document.createElement("embed");
...
//        newApplet.archive=java;
	...
	newApplet.setAttribute('code','chemaxon/marvin/applet/JMSketchLaunch');
		newApplet.setAttribute('archive',java);
//        newApplet.codebase_lookup='false";
//        newApplet.java_arguments='-Djnlp.packEnabled=true -Xmx512m";
//        newApplet.codebase='/marvin';
        newApplet.setAttribute('codebase','https://java.sun.com/update/1.6.0/jinstall-6u25-windows-i586.cab#Version=1,6,0,0');
	newApplet.setAttribute('java_arguments','-Djnlp.packEnabled=true -Xmx512m');
        newApplet.setAttribute('legacy_lifecycle','true');
        newApplet.tabIndex = -1; // Not directly tabbable
//        newApplet.mayScript = true;     
	newApplet.id = appletid;
        newApplet.setAttribute('type','application/x-java-applet;version=1.6');


//	newApplet.setAttribute('java_arguments','-Djnlp.packEnabled=true -Xmx512m');
	newApplet.setAttribute('pluginspage','https://java.sun.com/javase/downloads/index.jsp');
...
//	newApplet.setAttribute('menubar','false');
	...
	newApplet.setAttribute('mol', encodeURIComponent(document.getElementById(stripped_answer_id).value));
...
///insert it with object tag

        var newApplet = document.createElement("object");
//        newApplet.code="chemaxon/marvin/applet/JMSketchLaunch";
//        newApplet.code=appletclass;
//        newApplet.archive=java;
        newApplet.name=name;
	newApplet.setAttribute('id',appletid);
        newApplet.width=width;
        newApplet.height=height;
	newApplet.classid='clsid:8AD9C840-044E-11D1-B3E9-00805F499D93';
//	newApplet.setAttribute('codebase','https://java.sun.com/update/1.6.0/jinstall-6u25-windows-i586.cab#Version=1,6,0,0');
//		newApplet.setAttribute('archive',java);
//        newApplet.codebase_lookup='false";
//        newApplet.java_arguments='-Djnlp.packEnabled=true -Xmx512m";
...
var param=document.createElement('param');
	param.name='archive';
        param.value='appletlaunch.jar';
	newApplet.appendChild(param);
var param=document.createElement('param');
	param.name='code';
        param.value='chemaxon/marvin/applet/JMSketchLaunch';
	newApplet.appendChild(param);
var param=document.createElement('param');
...
var param=document.createElement('param');
	param.name='java_arguments';
        param.value='-Djnlp.packEnabled=true -Xmx512m';
	newApplet.appendChild(param);
var param=document.createElement('param');
	param.name='menubar';
        param.value='false';
...
//var param=document.createElement('param');
//	param.name='classid';
//        param.value='clsid:8AD9C840-044E-11D1-B3E9-00805F499D93';
//	newApplet.appendChild(param);
...
M.qtype_easyomech.init_showarrowsrev = function(Y, moodle_version, slot){
    var handleSuccess = function(o) {
