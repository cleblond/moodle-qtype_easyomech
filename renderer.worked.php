...
//		$stripped_xml=$this->remove_xml_tags($answer->answer,'MEFlow');
		...
		$result .= html_writer::tag('textarea', $stripped_xml, array('id' => $stripped_answer_id, 'style' => 'display:none;'));
...
/////
		...
		$stripped_answer_id="stripped_answer".$qa->get_slot();
		$result .= html_writer::tag('textarea', $currentanswer, array('id' => $stripped_answer_id, 'style' => 'display:none;'));
